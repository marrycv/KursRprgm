...
test_that("Assignment: babylon()", {
  ...
  expect_equal(babylon(x=2, init=1.5, tol=0.01)$rot, 1.414216, tolerance = .001,
  ...
  expect_equal(babylon(x=15, init=1.5, tol=0.01)$rot, 3.872983, tolerance = .001,
  ...
  expect_equal(babylon(x=15, init=0.1, tol=0.01)$rot, 3.872983, tolerance = .001,
               info = "Fel: Approximationen är felaktig för x = 15, init = 1.5 och tol = 0.01.")
